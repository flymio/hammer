...
def time(hdr):
    ...
    if layer == 1:
        ...
        # brent@yiqyaq/jawbone, the following was 44100 in all cases, but by trial and error I found 3200 worked better at 16000
        # divisors for known sampling rates. If any of these change also change the corresponding value in lib/finalmp3.py seconds_per_frame_by_samplerate
        #   samplingrate    denominator
        #       8000           16000
        #      11025           32000
        #      16000           32000
        #      22050           44100
...
def headers(f):
    """frames(file) -> (header) generator - a copy of frames() but only returns the header"""
